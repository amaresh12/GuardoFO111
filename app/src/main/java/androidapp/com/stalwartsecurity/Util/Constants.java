...
public class Constants {
    ...
    public static String VISITORS="visiterList";
    public static String STAFF="staffList";
    public static String STAFFLIST="staffVisitList";
    public static String ADDSTAFF="addStaffVisit";
    public static String INWARD="addMaterialInward";
    public static String OUTWARD="addMaterialOutward";
    public static String LOCATION_DETAILS="locationList";
    public static String FLAT_DETAILS_LIST="locationDetailList";
    public static String DELIVERYBOYS="deliveryTypeList";
    public static String BANNERS="bannerList";
    public static String PRIMARYNOTICE="primaryNotificationList";
    public static String STAFFTYPE="staffTypeList";
    public static String SHAREDPREFERENCE_KEY="stalwart";
    public static String N_USER_ID="user_id";
